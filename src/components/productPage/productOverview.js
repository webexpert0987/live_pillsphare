      ...
      {isMobile ? (
          ...
          {[
            ...
            >
              <AccordionSummary
                ...
                sx={{ fontWeight: "500", fontSize: "15px", color: "#FFF" }}
              >
                {tab.title}
              </AccordionSummary>
              <AccordionDetails
        ...
        <>
          ...
          >
            ...
            <StyledTab
              icon={
                <img src="/images/medicineSVG.svg" width="30px" height="30px" />
              }
              label="Information"
              sx={{
                marginRight: { xs: "0", sm: "4%", md: "5%" },
          ...
          >
            ...
            {tabIndex === 3 && (
              <Typography>
                Details about shipping, delivery timelines, and return policies.
              </Typography>
            )}
          </Box>
        </>
