          ...
          <Box>
            ...
            <Box component="ul" sx={{ pl: 3 }}>
              ...
              <Typography component="li" variant="body1">
                ...
                that you provided when registering by updating your personal
            ...
            <Box component="ul" sx={{ pl: 3 }}>
              <Typography component="li" variant="body1">
                ...
                stated, these sites are not under the control of Pill Sphere LTD
            ...
            <Box component="ul" sx={{ pl: 3 }}>
              <Typography component="li" variant="body1">
                Any online facilities, tools, services, or information that Pill
                Sphere LTD makes available through the Website (the Service) is
                ...
                purpose, accuracy of information, compatibility, or satisfactory
                quality. Pill Sphere LTD is under no obligation to update
                information on the Website.
              </Typography>
              <Typography component="li" variant="body1">
                Whilst we use reasonable endeavors to ensure that the Website is
                secure and free of errors, viruses, and other malware, we give
                no warranty or guarantee in that regard, and all Users take
                responsibility for their own security, personal details, and
                computers.
              </Typography>
              <Typography component="li" variant="body1">
              ...
              <Typography component="li" variant="body1">
                We reserve the right to alter, suspend, or discontinue any part
                (or the whole of) the Website, including, but not limited to,
                any products and/or services available.
                <br />
            ...
            <Box component="ol" sx={{ pl: 3, listStyleType: "lower-alpha" }}>
              ...
              <Typography component="li" variant="body1">
                Limit or exclude any of our or your liabilities in any way that
            ...
            <Box component="ul" sx={{ pl: 3 }}>
              <Typography component="li" variant="body1">
                ...
                <br />
                We may transfer our rights under these terms where we reasonably
              ...
              <Typography component="li" variant="body1">
                ...
                these terms and conditions (or part-provision) is invalid,
            ...
            <Typography className="privacyPara" variant="body1">
              <strong>Pill Sphere LTD is a company registered in England and Wales with registered number 10580352. </strong>
            </Typography>
            <Typography className="privacyPara" variant="body1">
              <strong>Registered Address: </strong> Unit 2A and 2P Building B, Wembley Commercial Centre, Wembley, London, HA9 7UR
            </Typography>
            <Typography className="privacyPara" variant="body1">
              <strong>Email:</strong>
              <a
