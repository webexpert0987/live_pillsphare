...
const OnlineClinicHero = ({
  title = "Pill Sphere ",
  defultTitle = "Online Clinic",
  description = "Providing trustworthy, honest and discreet service online to treat common health conditions ",
  points = [
...
export default OnlineClinicHero;
