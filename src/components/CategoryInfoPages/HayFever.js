  ...
  const MedicalReferences = [
    {
      ...
      description:
        "Fully regulated and compliant with MHRA and GPhC guidelines.",
    },
    {
      id: 2,
      ...
      description:
        "Information on antihistamines, nasal sprays, and eye drops.",
    },
    {
      id: 3,
      image: require("../../pages/images/Info-Images/MHRA.png"),
      title: "MHRA (Medicines and Healthcare products Regulatory Agency)",
      description: "Safety information for hay fever medications.",
    },
    {
      id: 4,
